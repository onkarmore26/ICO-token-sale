            ...
            >
              <div className="contact_title">
                ...
                >
                  ...
                  Reach out to us through the contact form, and we'll get back
              ...
              <ul className="list_none contact_info mt-margin">
                ...
                >
                  ...
                  <div className="contact_detail">
                    <span>Address</span>
                    <p>22 International Division via B, G Mumbai</p>
                  </div>
                </li>
                <li
                  className="animation"
                ...
                >
                  ...
                  <div className="contact_detail">
                    <span>Email-Id</span>
                    <p>radiantblockcore@gmail.com</p>
                  </div>
                </li>
              </ul>
              ...
              <div className="contct_follow pt-2 pt-md-4">
                ...
                <ul className="list_none social_icon">
                  <li
                    ...
                    data-animation-delay="0.2s"
                  >
                    <a href="https://www.facebook.com/" className="icon_color">
                      <FaFacebook className="icon_color" />
                    </a>
                  </li>
                  <li
                    className="animation"
                    ...
                    data-animation-delay="0.2s"
                  >
                    <a href="https://www.instagram.com/" className="icon_color">
                  ...
                  <li
                    ...
                    data-animation-delay="0.2s"
                  >
                    <a href="https://x.com/" className="icon_color">
                  ...
                  <li
                    ...
                    data-animation-delay="0.2s"
                  >
                    <a href="https://www.linkedin.com/" className="icon_color">
                  ...
                  <li
                    ...
                    data-animation-delay="0.2s"
                  >
                    <a href="https://www.youtube.com/" className="icon_color">
